    ...
    public render() {
        ...
        return (
            <div className={classes.root}>
                ...
                {
                    PlayersService.getPlayersByTeam(this.state.selectedTeam).map((player) => {
                    const playerTrending = stores.trendingStore.getPlayerTrendingStats(player.id)
                    return <TrendingRowContainer
                            player={player}
                            playerTrendingStats={playerTrending}
                        />
                    })
                }
            </div>
